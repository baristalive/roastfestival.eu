...
export const Colab = () => {
  ...
  return (
    <section
      ref={ref}
      className="colab-section grid gap-32 px-8 lg:grid-cols-[1fr,2fr] pb-48"
    >
      ...
      <div className="grid grid-cols-2 items-center justify-center gap-24 pt-36 text-xl">
        <div className="card elevate nav h-full rounded-2xl p-12">
          ...
          >
            <h3 className="text-3xl font-bold">{lang.colab.exhibitors.title}</h3>
        ...
        <div className="card elevate nav h-full rounded-2xl p-12">
          ...
          >
            <h3 className="text-3xl font-bold">{lang.colab.sponsors.title}</h3>
