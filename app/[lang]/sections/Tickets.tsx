            ...
            return (
              <div
                ...
                className={`relative flex flex-col ${
                  isFeatured
                    ? "bg-accent text-black shadow-[20px_20px_0px_0px_var(--color-primary)] md:-translate-y-8"
                    : "bg-secondary group text-black"
                }`}
              >
                <div className="flex h-12 w-full items-center justify-between bg-black px-4">
                  ...
                  {isFeatured && (
                    <span className="bg-secondary px-2 py-0.5 text-xs font-bold text-black uppercase">
                ...
                <div className="flex grow flex-col border-x-4 border-b-4 border-black p-8">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="external"
                    className={`font-display w-full bg-black py-4 text-center text-xl font-black text-white uppercase transition-colors ${
                      isFeatured
                        ? "hover:bg-primary"
                        : idx === 0
