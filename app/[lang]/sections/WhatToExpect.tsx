...
export const WhatToExpect = () => {
  ...
  return (
    <section id="what-to-expect" className="pt-12 sm:pt-0 lg:pb-24">
      <div className="mx-auto grid max-w-475 px-8 lg:grid-cols-[1fr,1fr]">
      ...
      <div className="mx-auto grid max-w-475 gap-4 px-8 py-12 md:px-12 lg:grid-cols-[1fr,1fr] lg:gap-16">
